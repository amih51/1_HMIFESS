...
export default function Nav() {
  ...
  return (
    <div className="fixed flex items-center justify-between md:block top-0 left-0 w-full md:w-64 h-16 md:h-screen bg-white dark:bg-gray-800 border-b-2 md:border-r-2 border-gray-200 dark:border-gray-800 z-50">
      <div className="flex md:mx-6 md:h-1/5 md:pt-16">
      ...
      <nav className="flex flex-col flex-shrink-0 justify-between h-3/4 overflow-y-auto bg-white dark:bg-gray-800">
